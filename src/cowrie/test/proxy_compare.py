...
class ProxyTestCommand:
    ...
    """
    def __init__(self, type, hostname, port_backend, port_proxy,
                 username_backend, password_backend,
    ...
    def execute_both(self, command):
        ...
        self.execute(self.hostname, self.port_backend, self.username_backend, self.password_backend,
                     command, callback_backend)
        self.execute(self.hostname, self.port_proxy, self.username_proxy, self.password_proxy,
                     command, callback_proxy)
