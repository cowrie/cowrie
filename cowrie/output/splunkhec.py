...
class Output(cowrie.core.output.Output):
    ...
    def __init__(self, cfg):
        ...
        """
        self.token = cfg.get('output_splunkhec', 'token')
        self.url = cfg.get('output_splunkhec', 'url')
        try:
            self.index = cfg.get('output_splunkhec', 'index')
        except:
            self.index = None
        try:
            self.source = cfg.get('output_splunkhec', 'source')
        except:
            self.source = None
        try:
            self.sourcetype = cfg.get('output_splunkhec', 'sourcetype')
        except:
            self.sourcetype = None
        try:
            self.host = cfg.get('output_splunkhec', 'host')
        except:
            self.host = None
